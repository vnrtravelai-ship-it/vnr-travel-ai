...
- Specialized Recommendation Scorers
- Planner Repair Loop
- Weather Engine
- Pricing Engine
...
- Specialized Hotel Scorer
- Specialized Train Scorer
- Specialized Restaurant Scorer
- Specialized Tour Scorer
- Specialized Specialty Scorer
...
AI Providers must never contain business rules.

Planning Engine remains the single source of truth.

All future AI providers must implement AIProvider.
